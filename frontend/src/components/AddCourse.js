...
const AddCourse = ({ onClose }) => {
  ...
  const handleDeleteCourseImage = async (index) => {
  ...
  return (
    <div className="fixed w-full h-full bg-slate-200 bg-opacity-60 top-0 left-0 right-0 bottom-0 flex justify-center items-center">
      <div className=" p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
                ...
                {data.image.map((el, index) => {
                  return (
                    <div className="relative group">
                      ...
                      />
                      <div
                        onClick={() => handleDeleteCourseImage(index)}
